...
- **Mobile shell model:** install PWA from **`PUBLIC_BASE_URL`** — UI (~3 MB) caches on device; AI, comms, DB, and uploads stay on the production server (`GET /api/stack/mobile`). See **`MOBILE_DEPLOYMENT.md`**.
