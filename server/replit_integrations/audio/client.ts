...
/**
 * Voice Chat: user audio in → LLM audio out (`gpt-audio`).
 * Hosted Replit deployments may inject integration keys; locally use configured OpenAI credentials.
 * Browser capture is often WebM/opus — convert to WAV (e.g. ffmpeg) before calling when required.
 */
