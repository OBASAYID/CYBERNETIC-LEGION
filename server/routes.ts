...
import { getCyrusChatModel } from "./ai/cyrus-model.js";
...
async function loadDependencies() {
  ...
  if (commsOnlyMode) {
    try {
      ...
      const dbInitM = await import("./comms/db-init.js");
    ...
    try {
      const sgM = await import("./comms/signaling.js");
      initSignalingServer = sgM.initSignalingServer;
      const ssM = await import("./comms/socket-signaling.js");
      initSocketSignaling = ssM.initSocketSignaling;
      try {
        const ccSock = await import("./comms/cyrus-comm-socket.js");
      ...
      const stM = await import("./comms/store.js");
      ...
      const crM = await import("./comms/comms-routes.js");
  ...
  try {
    const nfM = await import("./ai/neural-fusion.js");
  ...
  try {
    const csM = await import("./ai/cyrus-soul.js");
  ...
  try {
    const qcM = await import("./ai/quantum-core.js");
  ...
  try {
    const brM = await import("./ai/branches/index.js");
  ...
  if (!disableReplitIntegrations) {
    try {
      const arM = await import("./replit_integrations/audio/routes.js");
      registerAudioRoutes = arM.registerAudioRoutes;
      const acM = await import("./replit_integrations/audio/client.js");
  ...
  try {
    const elM = await import("./elevenlabs/client.js");
  ...
  try {
    const auM = await import("./autonomy/run.js");
  ...
  try {
    const drM = await import("./device/routes.js");
  ...
  try {
    const nvM = await import("./nav/routes.js");
  ...
  try {
    const dtM = await import("./ingestion/detect.js");
    detectFile = dtM.detectFile;
    const exM = await import("./ingestion/extract.js");
    extractFile = exM.extractFile;
    const anM = await import("./ingestion/analyze.js");
    analyzeExtraction = anM.analyzeExtraction;
    const rpM = await import("./ingestion/report.js");
    buildReport = rpM.buildReport;
    const jobsM = await import("./ingestion/jobs.js");
  ...
  try {
    const dgM = await import("./docgen/generate.js");
    generateDocument = dgM.generateDocument;
    const dgExportM = await import("./docgen/export.js");
    exportGeneratedDocument = dgExportM.exportGeneratedDocument;
    const dgJobsM = await import("./docgen/jobs.js");
  ...
  try {
    const scM = await import("./scan/analyze.js");
    analyzeScan = scM.analyzeScan;
    const qrM = await import("./scan/qr.js");
    decodeQr = qrM.decodeQr;
    const drnM = await import("./drone/routes.js");
  ...
  try {
    const emM = await import("./ai/experience-memory.js");
  ...
  try {
    const alM = await import("./ai/adaptive-learning.js");
  ...
  try {
    const aurM = await import("./ai/upgrades/routes.js");
  ...
  try {
    const irM = await import("./ai/interactive/routes.js");
  ...
  autonomyRoutes = null;
  try {
    const autoM = await import("./autonomy/routes.js");
  ...
  try {
    const dcM = await import("./data-collection/routes.js");
  ...
  try {
    const assetM = await import("./assets/asset-routes.js");
  ...
  try {
    const qbM = await import("./ai/quantum-bridge-client.js");
    quantumBridge = qbM.quantumBridge;
    const qrfM = await import("./ai/quantum-response-formatter.js");
  ...
  try {
    const hiM = await import("./health/integrations.js");
  ...
  if (!disableReplitIntegrations) {
    try {
      const imgRM = await import("./replit_integrations/image/routes.js");
      registerImageRoutes = imgRM.registerImageRoutes;
      const imgCM = await import("./replit_integrations/image/client.js");
  ...
  try {
    const srM = await import("./ai/system-refinement-engine.js");
  ...
  try {
    const efM = await import("./humanoid/emotion-fusion.js");
    emotionFusion = efM.emotionFusion;
    const vpM = await import("./humanoid/voice-prosody.js");
    voiceProsody = vpM.voiceProsody;
    const humanoidM = await import("./humanoid/routes.js");
  ...
  try {
    const brainModule = await import("./ai/brain-routes.js");
...
export async function registerRoutes(
  ...
  app.post("/api/files/analyze", upload.single("file"), async (req: Request & { file?: MulterFile }, res) => {
    try {
      ...
      const analysis = await analyzeExtraction(ext, {
        jurisdiction,
        strictLegalReview,
        mode: mode as "standard" | "legal" | "audit" | "compliance" | undefined,
        docHint,
        analysisCommand,
        maxChunks,
      });
  ...
  app.post("/api/files/detect", upload.single("file"), async (req: Request & { file?: MulterFile }, res) => {
    try {
      ...
      const detection = await detectFile(buffer, req.file.mimetype);
      res.json(detection);
    } catch (err: any) {
  ...
  app.post("/api/files/extract", upload.single("file"), async (req: Request & { file?: MulterFile }, res) => {
    try {
      ...
      const extraction = await extractFile(buffer, req.file.mimetype);
      res.json(extraction);
    } catch (err: any) {
  ...
  app.post("/api/files/full-analysis", upload.single("file"), async (req: Request & { file?: MulterFile }, res) => {
    try {
      if (!req.file) {
        return res.status(400).json({ error: "No file uploaded" });
      }
      ...
      const hasContent = !!(
        ...
        (Array.isArray(extraction.frames) && extraction.frames.some((f: any) => f?.ocrText))
      );
      const report = buildReport(detection, extraction, analysis, hasContent);
      res.json(report);
    } catch (err: any) {
      console.error("Full file analysis failed:", err);
      return res.status(500).json({
        success: false,
        error: "Full file analysis failed",
        details: err?.message || String(err),
      });
    }
  });
  ...
  // QR-only decode — JSON { image: base64 } (matches /api/scan/ocr client). Multipart: use /api/scan/analyze.
  app.post("/api/scan/qr", async (req: Request, res) => {
    try {
      const raw = (req.body as { image?: string })?.image;
      if (!raw) {
        return res.status(400).json({
          success: false,
          error: "No image: POST JSON { image: base64 } (raw base64, no data: URL prefix).",
        });
      }
...
Format your response in a clear, structured manner.`
  ...
  app.post("/api/scan/detect-language", async (req: Request, res) => {
    try {
      const { text } = req.body || {};
      if (!text) {
      ...
      const response = await getOpenAIClient().chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "Detect the language of the provided text and return ONLY JSON: {\"detectedLanguage\":\"...\",\"confidence\":0.0}"
          },
      ...
      res.json({ success: true, detectedLanguage: "Unknown", confidence: 0 });
    }
  });

  app.post("/api/scan/interpret", async (req: Request, res) => {
    try {
      const { text } = req.body || {};
      if (!text) {
        return res.status(400).json({ success: false, error: "No text provided" });
      ...
      const response = await getOpenAIClient().chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "Interpret the provided text and return concise insights and any risk notes."
          },
          { role: "user", content: text }
        ],
        max_tokens: 500
      ...
      res.status(500).json({ success: false, error: "Interpretation failed", detail: err?.message || String(err) });
    }
  });

  app.post("/api/scan/report", async (req: Request, res) => {
    ...
    res.json({
      ...
      report: {
        ...
        summary: scanResult.interpretation || scanResult.text || "No scan details provided.",
        confidence: scanResult.confidence ?? null,
        riskNotes: scanResult.riskNotes || [],
      },
    });
  });
  ...
  app.post("/api/scan/detect-language", async (req: Request, res) => {
    try {
      ...
      const response = await getOpenAIClient().chat.completions.create({
        model: getCyrusChatModel(),
        messages: [
          { role: "system", content: "Detect the language of the provided text and return ONLY JSON: {\"detectedLanguage\":\"...\",\"confidence\":0.0}" },
          { role: "user", content: text }
        ],
        max_tokens: 120,
      });
  ...
  app.post("/api/scan/interpret", async (req: Request, res) => {
    try {
      ...
      const response = await getOpenAIClient().chat.completions.create({
        model: getCyrusChatModel(),
        messages: [
          { role: "system", content: "Interpret the provided text and return concise insights with any risk notes." },
          { role: "user", content: text }
        ],
        max_tokens: 500,
      });
      const interpretation = response.choices[0]?.message?.content || "No interpretation available.";
      res.json({ success: true, interpretation, text: interpretation, confidence: 0.9 });
    } catch (err: any) {
      res.status(500).json({ success: false, error: "Interpretation failed", detail: err?.message || String(err) });
    }
  });
  ...
  app.post("/api/infer", async (req, res) => {
    try {
      const { message, imageData, detectedObjects, location, userId, moduleContext, systemContext } = req.body;
  ...
  let executeAgentCore = async (command: string): Promise<any> => {
    const { runAutonomy } = await import("./autonomy/run.js");
...
Return ONLY valid JSON.`
  ...
  // ── PShare: legacy in-memory routes removed — use /api/comms/pshare/* ──
