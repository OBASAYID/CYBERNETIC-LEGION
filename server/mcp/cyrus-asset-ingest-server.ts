#!/usr/bin/env node
/** CYRUS Asset Ingestion MCP Server — stdio transport via shared registry. */

import readline from "readline";
import { getToolsForServer, invokeMcpTool } from "./mcp-registry.js";

const SERVER_ID = "cyrus-asset-ingest";
...
async function main(): Promise<void> {
  process.env.CYRUS_ML_ASSETS = process.env.CYRUS_ML_ASSETS ?? "true";
