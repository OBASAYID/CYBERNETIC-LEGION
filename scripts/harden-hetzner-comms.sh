...
upsert_env CYRUS_COMMS_MAX_UPLOAD_BYTES "${CYRUS_COMMS_MAX_UPLOAD_BYTES:-4294967296}"
upsert_env CYRUS_COMMS_CHUNK_BYTES "${CYRUS_COMMS_CHUNK_BYTES:-16777216}"
upsert_env HTTP_KEEP_ALIVE_TIMEOUT_MS "600000"
upsert_env HTTP_HEADERS_TIMEOUT_MS "610000"
