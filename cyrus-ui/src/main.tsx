...
function showBootFailure(message: string, detail?: string) {
  ...
  const detailHtml = detail
    ...
    : "";
  root.innerHTML = `
    <div style="min-height:100vh;min-height:100dvh;display:flex;align-items:center;justify-content:center;background:#000;color:#fff;padding:max(24px,env(safe-area-inset-top)) max(24px,env(safe-area-inset-right)) max(24px,env(safe-area-inset-bottom)) max(24px,env(safe-area-inset-left));font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;">
