...
const THEMES: ModuleTileTheme[] = [
  {
    ...
    background: "bg-gradient-to-br from-cyan-500/[0.18] via-slate-900/50 to-cyan-950/35",
    icon: "text-cyan-300",
    label: "text-cyan-50",
    sub: "text-cyan-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(34,211,238,0.45)]",
    corner: "from-cyan-500/20",
  },
  {
    border: "border-orange-400/35",
    background: "bg-gradient-to-br from-orange-500/[0.16] via-slate-900/50 to-amber-950/30",
    icon: "text-orange-300",
    label: "text-amber-50",
    sub: "text-orange-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(251,146,60,0.4)]",
    corner: "from-orange-500/20",
  },
  {
    border: "border-violet-400/40",
    background: "bg-gradient-to-br from-violet-500/[0.16] via-slate-900/50 to-fuchsia-950/30",
    icon: "text-violet-300",
    label: "text-violet-50",
    sub: "text-violet-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(167,139,250,0.45)]",
    corner: "from-violet-500/20",
  },
  {
    border: "border-emerald-400/35",
    background: "bg-gradient-to-br from-emerald-500/[0.16] via-slate-900/50 to-emerald-950/32",
    icon: "text-emerald-300",
    label: "text-emerald-50",
    sub: "text-emerald-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(52,211,153,0.4)]",
    corner: "from-emerald-500/20",
  },
  {
    border: "border-sky-400/40",
    background: "bg-gradient-to-br from-sky-500/[0.15] via-slate-900/50 to-sky-950/30",
    icon: "text-sky-300",
    label: "text-sky-50",
    sub: "text-sky-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(56,189,248,0.4)]",
    corner: "from-sky-500/20",
  },
  {
    border: "border-rose-400/35",
    background: "bg-gradient-to-br from-rose-500/[0.15] via-slate-900/50 to-rose-950/30",
    icon: "text-rose-300",
    label: "text-rose-50",
    sub: "text-rose-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(251,113,133,0.4)]",
    corner: "from-rose-500/20",
  },
  {
    border: "border-amber-400/40",
    background: "bg-gradient-to-br from-amber-500/[0.15] via-slate-900/50 to-amber-950/32",
    icon: "text-amber-300",
    label: "text-amber-50",
    sub: "text-amber-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(251,191,36,0.45)]",
    corner: "from-amber-500/20",
  },
  {
    border: "border-fuchsia-400/30",
    background: "bg-gradient-to-br from-fuchsia-500/[0.15] via-slate-900/50 to-fuchsia-950/30",
    icon: "text-fuchsia-300",
    label: "text-fuchsia-50",
    sub: "text-fuchsia-100/80",
    glow: "shadow-[0_0_28px_-8px_rgba(232,121,249,0.4)]",
    corner: "from-fuchsia-500/20",
  },
];
