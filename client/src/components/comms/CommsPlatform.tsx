...
export function CommsPlatform({
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col overflow-hidden bg-transparent">
      ...
      />
      {sidebar && (
        <div className="relative hidden w-16 shrink-0 flex-col items-center border-r border-amber-500/20 bg-gradient-to-b from-amber-950/25 to-slate-950/50 py-4 lg:flex">
          {sidebar}
        </div>
      )}

      <div
        className={`relative w-full shrink-0 border-r border-amber-500/25 bg-gradient-to-b from-amber-950/20 via-slate-950/40 to-orange-950/15 shadow-[inset_0_0_40px_rgba(251,146,60,0.06)] md:w-80 lg:w-80 ${
      ...
      <div
        className={`relative min-h-0 min-w-0 flex-1 bg-gradient-to-br from-cyan-950/25 via-slate-950/50 to-orange-950/18 ${
      ...
      {roster && (
        <div className="hidden w-[min(100%,18rem)] shrink-0 min-[1100px]:flex min-[1100px]:flex-col min-[1100px]:border-l min-[1100px]:border-amber-500/25">
          {roster}
        </div>
      )}
      </div>
      ...
      {newChatMode && onNewChatSend && (
        <div className="relative z-40 shrink-0 border-t border-orange-500/40 bg-gradient-to-r from-slate-950/98 via-orange-950/30 to-cyan-950/40 shadow-[0_-8px_32px_-6px_rgba(249,115,22,0.25)] backdrop-blur-md">
          <div className="flex items-center justify-between gap-2 px-3 py-1.5">
            <p className="min-w-0 text-[10px] font-mono text-orange-200/90">
