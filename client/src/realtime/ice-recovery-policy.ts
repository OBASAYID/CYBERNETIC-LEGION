...
export const CYRUS_PACKET_LOSS_RESTART_PCT = 12;
/** Video bitrate (kbps) below this for BITRATE_FROZEN_MS while live → possible restart. */
export const CYRUS_BITRATE_FROZEN_KBPS = 35;
/** Duration bitrate must stay frozen before recovery (ms). */
export const CYRUS_BITRATE_FROZEN_MS = 14_000;
/** After this many auto-restarts, prefer relay for remainder of browser session. */
export const CYRUS_RESTARTS_BEFORE_RELAY_ESCALATION = 3;
